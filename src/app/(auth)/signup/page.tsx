    ...
    <div className="w-full max-w-md rounded-2xl border border-white/[0.04] bg-zinc-950/60 backdrop-blur-xl p-8 sm:p-10 shadow-2xl shadow-black relative z-10 flex flex-col gap-6">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <div className="text-center mt-2">
          <h2 className="text-lg font-bold text-zinc-100">Create account</h2>
          <p className="text-xs font-mono text-zinc-500 mt-1">Get started with the command desk</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider">Full name</label>
          <input
            type="text"
            required
